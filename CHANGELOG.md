...
### Added
- `--append` option: Append steps to existing tour file (requires `--output` option)

### Fixed
- Remove unreachable code in `generateStepDescription`: isNewFile=true with addedLines.length>0 condition

## [0.0.6] - 2026-01-22

### Added
- Support for specifying three or more commits to generate a CodeTour showing the progression of changes

### Changed
- Modified command-line interface to accept multiple commit arguments instead of just two
